...
FS data set name 3 | TANDER_ANALYTICS_SALES_BY_OUTLET_ADLS_DS
FS data set name 3 path | OUTPUT/RUSSIA_DEMAND_ANALYTICS_PETCARE/TANDER_ANALYTICS/TNDR_SALES_BY_OL.PARQUET
DB data set name 3 | TANDER_ANALYTICS_SALES_BY_OUTLET_SQLDB_DS
DB data set name 3 path | [dbo].[SL_OT_TANDER_SALES_OUTLETS]
FS data set name 4 | TANDER_ANALYTICS_SALES_BY_SKU_ADLS_DS
FS data set name 4 path | OUTPUT/RUSSIA_DEMAND_ANALYTICS_PETCARE/TANDER_ANALYTICS/TNDR_SALES_BY_SKU.PARQUET
DB data set name 4 | TANDER_ANALYTICS_SALES_BY_SKU_SQLDB_DS
DB data set name 4 path | [dbo].[SL_OT_TANDER_SALES_SKU]
